...
private Ordine ord;
private ArrayList<Prodotto> lista1;
private Prodotto p1;
private Prodotto p2;
private ArrayList<Prodotto> lista2;
private Prodotto p3;
private Prodotto p4;
	...
	public void setUp() throws Exception {
		...
		p1= new Prodotto(134 ,"ribicus" ,"./Immagine/test1","questo è un test 1...",12,3.2);
		p2= new Prodotto(25 ,"rosa" ,"./Immagine/test2","questo è un test 2...",12,3.2);
		p3= new Prodotto(47 ,"viola" ,"./Immagine/test3","questo è un test 3...",12,3.2);
		p4= new Prodotto(98 ,"melissa" ,"./Immagine/test4","questo è un test 4...",12,3.2);
		lista2 = new ArrayList<Prodotto>();
		lista1 = new ArrayList<Prodotto>();
