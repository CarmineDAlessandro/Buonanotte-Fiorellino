...
public class CarrelloManagerTest {
	...
	public void testAggiungiProdottoCarrello() throws SQLException {
		boolean flag;
		flag = model.aggiungiProdottoCarrello("roccomiele1", 1, 250); //aggiungo quantit‡ eccessiva
		assertEquals(false,flag);
		flag = model.aggiungiProdottoCarrello("roccomiele1", 1, 10); //aggiungo quantit‡ eccessiva
		assertEquals(false,flag);
	}
